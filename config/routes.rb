Rails.application.routes.draw do
  namespace :api do
    ...
    namespace :v1 do
      ...
      # Доступные дни/слоты предзаказа — считает backend (единый источник
      # истины для часов работы + тайминга готовки/доставки), а не фронтенд
      get :delivery_slots, to: 'delivery_slots#show'
