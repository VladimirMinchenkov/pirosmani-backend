      ...
      def serialize_item(item)
        if item[:type] == :menu_item
          mi = item[:record]
          {
            ...
            price: mi.price.to_f,
            image_url: mi.image.attached? ? Rails.application.routes.url_helpers.url_for(mi.image) : mi.image_url,
          ...
          group = item[:record]
          {
            ...
            image_url: group.image.attached? ? Rails.application.routes.url_helpers.url_for(group.image) : group.image_url,
