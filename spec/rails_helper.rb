...
# WebMock блокирует ВСЕ реальные HTTP-запросы в тестах по умолчанию — это
# ровно то, что нужно для тестов Yandex Delivery Claims API (create/accept/
# cancel/tracking): любой тест, забывший явно стабнуть запрос, упадёт с
# понятной ошибкой вместо реального сетевого вызова.
